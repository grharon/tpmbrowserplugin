...
/**
 * Example class using the strService service.
 *
 * @author Sean
 */
public class strServiceUsageExample extends VerticalPanel {
    private Label lblServerReply = new Label();
    private TextBox txtUserInput = new TextBox();
    private Button btnSend = new Button("Send to server");
    
    public strServiceUsageExample() {
    ...
    public static strServiceAsync getService() {
