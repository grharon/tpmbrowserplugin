========================================================================
		ActiveX Control DLL : HELLOWORLD
========================================================================

ControlWizard has created this project for your HELLOWORLD ActiveX Control
...
that make up your HELLOWORLD ActiveX Control DLL.
...
HelloWorldCtl.h
	This file contains the declaration of the CHelloWorldCtrl C++ class.

HelloWorldCtl.cpp
	This file contains the implementation of the CHelloWorldCtrl C++ class.

HelloWorldPpg.h
	This file contains the declaration of the CHelloWorldPropPage C++ class.

HelloWorldPpg.cpp
	This file contains the implementation of the CHelloWorldPropPage C++ class.

HelloWorldCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CHelloWorldCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file HelloWorld.rc.
