...
BEGIN_DISPATCH_MAP(CHelloWorldCtrl, COleControl)
	...
	DISP_FUNCTION(CHelloWorldCtrl, "getPublicKeyContent", getPublicKeyContent, VT_BSTR, VTS_NONE)\
	
	DISP_FUNCTION(CHelloWorldCtrl, "doSignature", doSignature, VT_BSTR, VTS_BSTR VTS_BSTR)//, VTS_NONE)
	//}}AFX_DISPATCH_MAP
...
BSTR CHelloWorldCtrl::getPublicKeyContent()
{				
	CString strResult;
	// TODO: Add your dispatch handler code here
	strResult="12334";
...
BSTR CHelloWorldCtrl::doSignature(BSTR a, BSTR b)
{
	CString strResult;
	// TODO: Add your dispatch handler code here
	strResult="dvVBWyZL7EOEHDt7BFfcy8v+9cBnkBPyEmOt02lMJ7bJ0neru+3rcEDD43I00GLPjYZljJlX82u9qqphSZWgd1ADAkHVQZaAlm9tOIM1ZvBlb9XEkvtA5VyIkYLkr8LioGy1kv+bwfAwy6F0Bmi4YMNXVG+rUEvJksfeQ5desAw=";
	return strResult.AllocSysString();
}