...
<div>
	<img src="img/splitpoint_logo.jpg" alt="logo" style="margin-left: 210px;">
	...
	<tr>
			...
			<tr height="100px">
				<td>
					...
					if(unAuth) {
						...
						out.println("Please sign in before any opration.");
					}
					%>
			 		</b></font></div>
				</td>
		...
		<table border="0px" cellspacing="0" cellpadding="0"
			...
			<tbody>
				...
				<TR>
					<TD><div style="margin-left: 50px">User name:&nbsp;&nbsp;</div></TD>
				...
				<TR>
					<TD><div style="margin-left: 50px">Password:&nbsp;&nbsp;</div></TD>
					<td><div style="margin-right: 50px"><INPUT TYPE="PASSWORD" ID="j_password" NAME="j_password"></div>
					</td>
				</TR>
				<% if (useTPM) { %>
				<TR>
					<TD align="right"><div>TPM key password:&nbsp;&nbsp;</div></TD>
